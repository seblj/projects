...
class Report:
    ...
    def move_templates(self):
        os.system("cp ~/UiT/IFI-resources/latex_template/report.tex $PWD")
        os.system("cp ~/UiT/IFI-resources/latex_template/report.pdf $PWD")
        os.system("cp ~/UiT/IFI-resources/latex_template/references.bib $PWD")
